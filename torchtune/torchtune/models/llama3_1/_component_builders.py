...
def llama3_1_segment(
    ...
    # initialize segment embeddings weight with normal distribution of mean 0 and std 0.001
    nn.init.normal_(seg_embeddings.weight, mean=0, std=0.01) # Weight initialization can be tuned, we use 0.01  for llama3_1_8B
    output_proj = nn.Linear(embed_dim, vocab_size, bias=False)
