...
from torchtune.models.llama3._component_builders import llama3, lora_llama3, llama3_segment, lora_llama3_segment
...
def llama3_8b_segment() -> TransformerDecoderSeg:
    return llama3_segment(
        segment_size=4,
        vocab_size=128_256,
        num_layers=32,
        num_heads=32,
